                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: Opacity(
                                  ...
                                  child: customText(widget.text, widget.textSize, FontWeight.w600, widget.isActive ? darkBlueColor : dark? Colors.white:yellowColor, 1,))),
                        ),
                      Icon(widget.icon, color: widget.isActive ? darkBlueColor: dark? Colors.white:yellowColor, size: widget.iconSize),
                    ],
                  );
              },
            ),
